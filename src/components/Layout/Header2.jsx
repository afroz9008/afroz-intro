  ...
  return (
    <>
      ...
      >
        ...
        <Link to="/multipage" className="logo" style={{height:50,width:50,borderRadius:25,overflow:"hidden"}}>
      ...
      >
        ...
        <div className="header-inner d-flex align-items-start flex-column">
          <Link to="/multipage" style={{height:50,width:50,borderRadius:25,overflow:"hidden"}}>
            <img src={headerData.imageThumb} alt={headerData.name} />
          </Link>
